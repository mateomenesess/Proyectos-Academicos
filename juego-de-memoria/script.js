...
opciones.push(["SUDAFRICA", "SINGAPUR", "CANADA"]);
opciones.push(["PERU", "ITALIA", "ARGENTINA"]);
opciones.push(["TUNEZ", "COLOMBIA", "ANTIGUA Y BARBUDA"]);
opciones.push(["UCRANIA", "ESPAÑA", "MADAGASCAR"]);
opciones.push(["CHILE", "OMAN", "ETIOPIA"]);
